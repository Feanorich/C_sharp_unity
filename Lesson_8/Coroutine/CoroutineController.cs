    ...
    public void PauseResume()
    {
        ...
        {            
            case CoroutineState.Running:
                state = CoroutineState.Paused;
                Debug.Log($"!!! притормозили {_routine}");
                break;
            case CoroutineState.Paused:
                state = CoroutineState.Running;
                Debug.Log($"!!! восстановили {_routine}");
                break;            
            default:
                throw new System.InvalidOperationException("Unable to change coroutine in state: " + state);
        }
